...
[![Moodle 5.2](https://img.shields.io/badge/Moodle-5.2-blue.svg)](https://moodle.org)
...
- 🎯 [Moodle Demo](https://school.moodledemo.net/) - Try Moodle without installation to explore features and functionality in a live environment. The demo site is a perfect sandbox for experimenting with Moodle's capabilities.
...
- 🇪🇸 [Spanish (Español)](https://download.moodle.org/langpack/4.5/es.zip) - The official Spanish language pack for Moodle.
- 🇫🇷 [French (Français)](https://download.moodle.org/langpack/4.5/fr.zip) - The official French language pack for Moodle.
- 🇩🇪 [German (Deutsch)](https://download.moodle.org/langpack/4.5/de.zip) - The official German language pack for Moodle.
- 🇯🇵 [Japanese (日本語)](https://download.moodle.org/langpack/4.5/ja.zip) - The official Japanese language pack for Moodle.
- 🇷🇺 [Russian (Русский)](https://download.moodle.org/langpack/4.5/ru.zip) - The official Russian language pack for Moodle.
